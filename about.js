...
function OpenModal(modal) {
  ...
  if (modal == 1) {
    ...
    pmore.innerHTML =
      "CSS<br>Expert in responsive design, using frameworks like Bootstrap and Tailwind CSS. Skilled in CSS Grid and Flexbox for efficient layouts, creating animations and transitions, with a strong focus on cross-browser compatibility and mobile-first principles.<br><br>" +
    ...
    pmore.innerHTML =
      "Python<br>Proficient in Python for web development, automation, and Discord bot creation. Experienced with frameworks like Django and Flask for building scalable web applications. Skilled in RESTful APIs, database integration, and backend logic development.<br><br>" +
    ...
    pmore.innerHTML =
      "Discord Server Management<br>Experienced in setting up and managing Discord servers, including configuring roles, permissions, channels, and moderation tools. Skilled in creating engaging communities, organizing events, and maintaining a positive, active environment. Proficient in using bots for automation, server moderation, and improving the user experience.<br><br>" +
    ...
    pmore.innerHTML =
      "We offer custom solutions designed to meet your unique needs and goals.\n" +
...
ScrollReveal().reveal(".home-img, .skills-container, .portfolio-box", {
  origin: "bottom",
});
ScrollReveal().reveal(".home-content h1, .aboutsite-img, .about-content", {
  origin: "left",
});
ScrollReveal().reveal(".about-img, .home-content p, .aboutsite-content", {
  origin: "right",
});
